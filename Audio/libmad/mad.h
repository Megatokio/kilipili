...
/* Id: version.h,v 1.26 2004/01/23 09:41:33 rob Exp */
  ...
  #define MAD_VERSION                       \
	  ...
	  "." MAD_VERSION_STRING(MAD_VERSION_MINOR) "." MAD_VERSION_STRING(MAD_VERSION_PATCH) MAD_VERSION_EXTRA
 ...
 */
  ...
  #define MAD_F_FRACBITS 28
	...
	#define MAD_F(x) ((mad_fixed_t)(x##L))
	  ...
	  #define MAD_F(x) ((mad_fixed_t)(((x##L) + (1L << (28 - MAD_F_FRACBITS - 1))) >> (28 - MAD_F_FRACBITS)))
 ...
 */
	  ...
	  #define mad_f_mul(x, y) \
		  ((mad_fixed_t)((((mad_fixed64_t)(x) * (y)) + (1L << (MAD_F_SCALEBITS - 1))) >> MAD_F_SCALEBITS))
	#else
 ...
 */
		...
		asm("addl %4,%2\n\t"                                                                           \
			...
			: "cc");                                                                                   \
		asm("shrdl %3,%2,%1" : "=rm"(__result) : "0"(__lo_), "r"(__hi_), "I"(MAD_F_SCALEBITS) : "cc"); \
		__result;                                                                                      \
			})
 ...
 */
		...
		#define mad_f_scale64(hi, lo)                                                            \
			({                                                                                   \
		mad_fixed_t __result;                                                                    \
		asm("shrdl %3,%2,%1" : "=rm"(__result) : "0"(lo), "r"(hi), "I"(MAD_F_SCALEBITS) : "cc"); \
		__result;                                                                                \
			})
	  #endif /* OPT_ACCURACY */
...
/* default implementations */
	...
	#if defined(OPT_ACCURACY)
	  #define mad_f_scale64(hi, lo) \
		  ((((mad_fixed_t)(((hi) << (32 - (MAD_F_SCALEBITS - 1))) | ((lo) >> (MAD_F_SCALEBITS - 1)))) + 1) >> 1)
	#else
...
void mad_decoder_init(
	...
	enum mad_flow (*)(void*, struct mad_stream*, struct mad_frame*), enum mad_flow (*)(void*, void*, unsigned int*));
