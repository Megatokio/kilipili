...
/*
 * NAME:	synth->reset()
 * DESCRIPTION:	re-initialize synth struct
 */
...
static void dct32(const mad_fixed_t in[32], uint slot, mad_fixed_t lo[16][8], mad_fixed_t hi[16][8])
{
  ...
  #define costab31 MAD_F(0x00c8fb30) /* 0.049067674 */
	...
	/* 28 */ lo[12][slot] = SHIFT((((MUL(t157 - t158, costab16) * 2) - t159) * 2) - t160);
	...
	/* 30 */ lo[14][slot] = SHIFT((((((MUL(t166 - t167, costab16) * 2) - t168) * 2) - t169) * 2) - t170);
	...
	t176 = (((((MUL(t161 - t162, costab16) * 2) - t163) * 2) - t164) * 2) - t165;

	/* 29 */ lo[13][slot] = SHIFT(t176);
	/* 31 */ lo[15][slot] = SHIFT((((((((MUL(t171 - t172, costab16) * 2) - t173) * 2) - t174) * 2) - t175) * 2) - t176);
...
static const mad_fixed_t D[17][32] = {
#include "D.dat"
};
