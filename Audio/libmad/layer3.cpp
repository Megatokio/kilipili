...
static struct
{
	...
	{sfb_12000_long, sfb_12000_short, sfb_12000_mixed}, {sfb_11025_long, sfb_11025_short, sfb_11025_mixed},
 ...
 */
static const mad_fixed_t imdct_s[6][6] = {
#include "imdct_s.dat"
};
...
static const mad_fixed_t window_l[36] = {
	...
	MAD_F(0x0bcbe352) /* 0.737277337 */, MAD_F(0x0cb19346) /* 0.793353340 */, MAD_F(0x0d7e8807) /* 0.843391446 */,

	MAD_F(0x0e313245) /* 0.887010833 */, MAD_F(0x0ec835e8) /* 0.923879533 */, MAD_F(0x0f426cb5) /* 0.953716951 */,
	MAD_F(0x0f9ee890) /* 0.976296007 */, MAD_F(0x0fdcf549) /* 0.991444861 */, MAD_F(0x0ffc19fd) /* 0.999048222 */,
	MAD_F(0x0ffc19fd) /* 0.999048222 */, MAD_F(0x0fdcf549) /* 0.991444861 */, MAD_F(0x0f9ee890) /* 0.976296007 */,
	MAD_F(0x0f426cb5) /* 0.953716951 */, MAD_F(0x0ec835e8) /* 0.923879533 */, MAD_F(0x0e313245) /* 0.887010833 */,

	MAD_F(0x0d7e8807) /* 0.843391446 */, MAD_F(0x0cb19346) /* 0.793353340 */, MAD_F(0x0bcbe352) /* 0.737277337 */,
	MAD_F(0x0acf37ad) /* 0.675590208 */, MAD_F(0x09bd7ca0) /* 0.608761429 */, MAD_F(0x0898c779) /* 0.537299608 */,
	MAD_F(0x07635284) /* 0.461748613 */, MAD_F(0x061f78aa) /* 0.382683432 */, MAD_F(0x04cfb0e2) /* 0.300705800 */,
	MAD_F(0x03768962) /* 0.216439614 */, MAD_F(0x0216a2a2) /* 0.130526192 */, MAD_F(0x00b2aa3e) /* 0.043619387 */,
};
#endif /* ASO_IMDCT */
...
static const mad_fixed_t window_s[12] = {
	...
	MAD_F(0x09bd7ca0) /* 0.608761429 */, MAD_F(0x061f78aa) /* 0.382683432 */, MAD_F(0x0216a2a2) /* 0.130526192 */,
};
...
static const mad_fixed_t is_lsf_table[2][15] = {
	{
		...
		MAD_F(0x04c1bf83) /* 0.297301779 */, MAD_F(0x04000000) /* 0.250000000 */, MAD_F(0x035d13f3) /* 0.210224104 */,
		MAD_F(0x02d413cd) /* 0.176776695 */, MAD_F(0x0260dfc1) /* 0.148650889 */, MAD_F(0x02000000) /* 0.125000000 */,
		MAD_F(0x01ae89fa) /* 0.105112052 */, MAD_F(0x016a09e6) /* 0.088388348 */, MAD_F(0x01306fe1) /* 0.074325445 */
	},
	{
		MAD_F(0x0b504f33) /* 0.707106781 */, MAD_F(0x08000000) /* 0.500000000 */, MAD_F(0x05a8279a) /* 0.353553391 */,
		MAD_F(0x04000000) /* 0.250000000 */, MAD_F(0x02d413cd) /* 0.176776695 */, MAD_F(0x02000000) /* 0.125000000 */,
		MAD_F(0x016a09e6) /* 0.088388348 */, MAD_F(0x01000000) /* 0.062500000 */, MAD_F(0x00b504f3) /* 0.044194174 */,
		MAD_F(0x00800000) /* 0.031250000 */, MAD_F(0x005a827a) /* 0.022097087 */, MAD_F(0x00400000) /* 0.015625000 */,
	...
	for (gr = 0; gr < ngr; ++gr)
	{
		...
		for (ch = 0; ch < nch; ++ch)
		{
			...
			*data_bitlen += channel->part2_3_length;
			...
			if (channel->big_values > 288 && result == 0) result = MAD_ERROR_BADBIGVALUES;
			...
			if (mad_bit_read(ptr, 1))
			{
				...
				if (!lsf && channel->block_type == 2 && si->scfsi[ch] && result == 0) result = MAD_ERROR_BADSCFSI;
...
static void III_exponents(struct channel const* channel, const unsigned char* sfbwidth, signed int exponents[39])
{
	...
	if (channel->block_type == 2)
	{
		...
		if (channel->flags & mixed_block_flag)
		{
			...
			{
				exponents[sfbi] =
					gain - (signed int)((channel->scalefac[sfbi] + (pretab[sfbi] & premask)) << scalefac_multiplier);
		...
		while (l < 576)
		{
			exponents[sfbi + 0] = gain0 - (signed int)(channel->scalefac[sfbi + 0] << scalefac_multiplier);
			exponents[sfbi + 1] = gain1 - (signed int)(channel->scalefac[sfbi + 1] << scalefac_multiplier);
			exponents[sfbi + 2] = gain2 - (signed int)(channel->scalefac[sfbi + 2] << scalefac_multiplier);
	...
	{ /* channel->block_type != 2 */
		if (channel->flags & preflag)
		{
			...
			{
				exponents[sfbi] = gain - (signed int)((channel->scalefac[sfbi] + pretab[sfbi]) << scalefac_multiplier);
			}
		}
		else
		{
			for (sfbi = 0; sfbi < 22; ++sfbi)
			{
				exponents[sfbi] = gain - (signed int)(channel->scalefac[sfbi] << scalefac_multiplier);
			}
		}
	}
}
	...
	unsigned int part2_length)
{
	...
	/* big_values */
	{
		...
		if (table == 0) return MAD_ERROR_BADHUFFTABLE;
	...
	if (cachesz + bits_left < 0) return MAD_ERROR_BADHUFFDATA; /* big_values overrun */
	...
	mad_fixed_t xr[2][576], struct granule const* granule, struct mad_header* header, const unsigned char* sfbwidth)
{
	...
	if (header->mode_extension & I_STEREO)
	{
		...
		{
			const unsigned char* illegal_pos = granule[1].ch[1].scalefac;
			const mad_fixed_t*	 lsf_scale;
...
#if defined(ASO_IMDCT)
void III_imdct_l(const mad_fixed_t[18], mad_fixed_t[36], unsigned int);
#else
  #if 1
static void fastsdct(const mad_fixed_t x[9], mad_fixed_t y[18])
{
...
static inline void sdctII(const mad_fixed_t x[18], mad_fixed_t X[18])
{
	mad_fixed_t tmp[9];
	int			i;

	/* scale[i] = 2 * cos(PI * (2 * i + 1) / (2 * 18)) */
	static const mad_fixed_t scale[9] = {MAD_F(0x1fe0d3b4), MAD_F(0x1ee8dd47), MAD_F(0x1d007930),
...
static inline void dctIV(const mad_fixed_t y[18], mad_fixed_t X[18])
{
	mad_fixed_t tmp[18];
	int			i;

	/* scale[i] = 2 * cos(PI * (2 * i + 1) / (4 * 18)) */
	static const mad_fixed_t scale[18] = {MAD_F(0x1ff833fa), MAD_F(0x1fb9ea93), MAD_F(0x1f3dd120), MAD_F(0x1e84d969),
										  MAD_F(0x1d906bcf), MAD_F(0x1c62648b), MAD_F(0x1afd100f), MAD_F(0x1963268b),
										  MAD_F(0x1797c6a4), MAD_F(0x159e6f5b), MAD_F(0x137af940), MAD_F(0x11318ef3),
										  MAD_F(0x0ec6a507), MAD_F(0x0c3ef153), MAD_F(0x099f61c5), MAD_F(0x06ed12c5),
										  MAD_F(0x042d4544), MAD_F(0x0165547c)};
 ...
 */
static inline void imdct36(const mad_fixed_t x[18], mad_fixed_t y[36])
{
	mad_fixed_t tmp[18];
	int			i;
 ...
 */
static inline void imdct36(const mad_fixed_t X[18], mad_fixed_t x[36])
{
 ...
 */
static void III_imdct_s(const mad_fixed_t X[18], mad_fixed_t z[36])
{
	mad_fixed_t		   y[36], *yptr;
	const mad_fixed_t* wptr;
	int				   w, i;
	mad_fixed64hi_t	   hi;
	mad_fixed64lo_t	   lo;
...
static enum mad_error III_decode(struct mad_bitptr* ptr, struct mad_frame* frame, struct sideinfo* si, unsigned int nch)
{
	...
	for (gr = 0; gr < ngr; ++gr)
	{
		...
		for (ch = 0; ch < nch; ++ch)
		{
			...
			{
				sfbwidth[ch] =
					(channel->flags & mixed_block_flag) ? sfbwidth_table[sfreqi].m : sfbwidth_table[sfreqi].s;
			}

			if (header->flags & MAD_FLAG_LSF_EXT)
			{
				part2_length =
					III_scalefactors_lsf(ptr, channel, ch == 0 ? 0 : &si->gr[1].ch[1], header->mode_extension);
			}
