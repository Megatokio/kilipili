...
// this file is for testing only - video will be weird!
...
#define VIDEO_PIXEL_GSHIFT 3
#define VIDEO_PIXEL_BSHIFT 6
#define VIDEO_PIXEL_RCOUNT 3
#define VIDEO_PIXEL_GCOUNT 3
