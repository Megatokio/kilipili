...
// convert vgaboard-style #defines
  ...
  #define VIDEO_ENABLE_CLOCKS  PICO_SCANVIDEO_ENABLE_CLOCK_PIN
  #define VIDEO_CLOCK_POLARITY PICO_SCANVIDEO_CLOCK_POLARITY
  #define VIDEO_DEN_POLARITY   PICO_SCANVIDEO_DEN_POLARITY

  #define VIDEO_COLOR_PIN_COUNT PICO_SCANVIDEO_COLOR_PIN_COUNT
  #define VIDEO_ALPHA_PIN		PICO_SCANVIDEO_ALPHA_PIN
...
#if !defined VIDEO_ENABLE_CLOCKS || !VIDEO_ENABLE_CLOCKS
  #undef VIDEO_ENABLE_CLOCKS
  #undef VIDEO_CLOCK_POLARITY
  #undef VIDEO_DEN_POLARITY
  #define VIDEO_ENABLE_CLOCKS  false
  #define VIDEO_CLOCK_POLARITY false
  #define VIDEO_DEN_POLARITY   false
#endif
